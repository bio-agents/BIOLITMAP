...
topics = ["Functional genomics", "Sequence analysis", "Structure analysis", "Molecular interactions, pathways and networks", "Mapping", "Molecular genetics", "Proteomics", "RNA", "Phylogeny", "Transcriptomics", "Pharmacogenomics", "Agents", "DNA"]
papers_per_topic = []
#topic_colors = []
...
for index, row in enumerate(cursor):
    ...
    if(index > 142 and index < 156):
        citations_per_year_agents.append(row[1])
    if(index > 155):
        citations_per_year_dna.append(row[1])

y_stack = np.row_stack((citations_per_year_funcgen, citations_per_year_seqan, citations_per_year_strucan, citations_per_year_molint, citations_per_year_mapping, citations_per_year_molgen, citations_per_year_proteomics, citations_per_year_rna, citations_per_year_phylo, citations_per_year_trans, citations_per_year_phar, citations_per_year_agents, citations_per_year_dna))
